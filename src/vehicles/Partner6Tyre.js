      ...
      <div className="row">
        <div className="col-lg-6 mb-3 overflow-hidden">
          <img
            ...
            src={require("../img/vehicles/Ashok-Leyland-Partner-Price-in-Hyderabad.webp")}
            alt="Bada-Dost-i3"
          />
        </div>
    ...
    <div className="container shadow rounded-3 border my-5">
      <div className="row p-3 align-items-center">
        ...
        <div className="col-lg-6 col-md-12 col-12 pe-0 mt-3 overflow-hidden">
          <img
            className="w-100"
            src={require("../img/vehicles/Ashok-Leyland-Partner-6tyre-Mileage.webp")}
